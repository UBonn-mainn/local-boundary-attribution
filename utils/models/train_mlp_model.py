...
def train_mlp_model_memory(
    ...
    print("Starting training (MLP Model)...")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train an MLP classifier on CSV data.")
    parser.add_argument("--data_path", type=str, required=True, help="Path to input CSV file")
    parser.add_argument("--save_path", type=str, default="models/checkpoints/mlp_model.pth", help="Path to save the trained model")
